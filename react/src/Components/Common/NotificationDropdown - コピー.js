                            ...
                            <SimpleBar style={{ maxHeight: "300px" }} className="pe-2">
                                    ...
                                    <div className="d-flex">
                                        ...
                                        <div className="flex-1">
                                            <Link to="#" className="stretched-link">
                                                <h6 className="mt-0 mb-2 lh-base">Yoshi, Your <b>Elite</b> author Graphic
                                    ...
                                    <div className="d-flex">
                                        ...
                                        <div className="flex-1">
                                            ...
                                            <div className="fs-13 text-muted">
                                                <p className="mb-1">Yoshi, Answered to your comment on the cash flow forecast's
                                                    graph 🔔.</p>
                                            </div>
                                            <p className="mb-0 fs-11 fw-medium text-uppercase text-muted">
                                ...
                                <div className="text-reset notification-item d-block dropdown-item position-relative">
                                    <div className="d-flex">
                                        ...
                                        <div className="flex-1">
                                            <Link to="#" className="stretched-link">
                                                <h6 className="mt-0 mb-2 fs-13 lh-base">Yoshi, You have received <b className="text-success">20</b> new messages in the conversation</h6>
                                            </Link>
                                            <p className="mb-0 fs-11 fw-medium text-uppercase text-muted">

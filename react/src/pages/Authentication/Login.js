                                ...
                                <Card className="mt-4">
                                    <CardBody className="p-4">
                                        <div className="text-center mt-2">
                                            <h5 className="text-primary">いつもお疲れ様です！</h5>
                                            <p className="text-muted">IDとパスワードを入力してログインしてください</p>
                                        </div>
                                            ...
                                            <Form
                                                ...
                                                <div className="mb-3">
                                                    <div className="float-end">
                                                        <Link to="/forgot-password" className="text-muted">ログインできません</Link>
                                                    </div>
                                                    <Label className="form-label" htmlFor="password-input">パスワード</Label>
                                                ...
                                                <div className="form-check">
                                                    ...
                                                    <Label className="form-check-label" htmlFor="auth-remember-check">ログイン情報を保存します</Label>
                                                </div>

                                                <div className="mt-4">
                                                    <Button color="success" className="btn btn-success w-100" type="submit">ログイン</Button>
                                                </div>
